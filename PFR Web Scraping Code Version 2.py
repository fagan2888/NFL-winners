...
class Scraper():
    ...
    def get_players_for_letter(self, letter):
        ...
        for player in players:
            ...
            elif len(player.contents[1].split(' ')) == 3:
    ...
    def get_seasons_with_stats(self, profile_soup):
        ...
        if len(gamelog_list) > 0 and gamelog_list[0].contents[0].contents[0] == 'Career':
            ...
            for season in gamelog_list:
                ...
                if season.contents[0].contents[0] == 'Career' or season.contents[0].contents[0] == 'Postseason' or int(season.contents[0].contents[0]) < 2010:

                    continue

                elif int(season.contents[0].contents[0]) >= 2010:
